...
function switchUser(id) {
  // Update active identity and immediately refresh the application shell.
  // Previously this only changed the select value because navigating to the
  // already-open dashboard hash did not always trigger a rerender.
  STATE.userId = id;
  STATE.navStack = [];
  render();
}
